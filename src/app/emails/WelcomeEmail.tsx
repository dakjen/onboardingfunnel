...
const WelcomeEmail: React.FC<WelcomeEmailProps> = ({ userName }) => {
  ...
  const logoUrl = "https://onboardingfunnel.vercel.app/ewelogo.png"; // UPDATED THIS LINE
  const websiteUrl = "https://elitewiseescapes.com"; // IMPORTANT: Replace with your actual website URL
        ...
        <tr>
          <td style={{ padding: '20px' }}>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                <td>
                  <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px'  }}>Thank you for joining Elitewise Escapes! We're thrilled to have you on board and excited to take the       
      stress out of planning your next adventure.</p>                                                               
                  <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px'      
       }}>You’re officially on my radar, and based on what you shared, I’m confident we can design a trip that feels 
       effortless, elevated, and tailored to your personal travel style.</p>                                         
                  <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px',     
       fontWeight: 'bold' }}>What Happens Next:</p>                                                                  
                  <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px' }}>  
       To begin crafting your custom recommendations, I’ll need a bit more detail about your travel preferences.     
       Please take a moment to complete your Client Profile in your secure travel portal:</p>                        
                 <p style={{ fontSize: '20px', lineHeight: '24px', marginTop: 0, marginBottom: '20px',     
       fontWeight: 'bold' }}>👉 Complete Your Client Profile:</p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <ul style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '30px', paddingLeft: '20px' }}>
                    ...
                    <li>✔ A seamless, done-for-you process from planning to takeoff</li>
                         ...
                         <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px'      
       }}>Whether you're planning a getaway, a milestone trip, or exploring options for future travel, I’ve got you  
       covered.</p>                                                                                                  
                                                                                                          
     <a href={websiteUrl} style={{ backgroundColor: '#23203e', color: '#ffffff', padding:'12px 20px', marginRight: '10px', marginLeft: '70px', borderRadius: '5px', display: 'inline-block', textDecoration: 'none', fontWeight: 'bold' }}>Explore The Website</a>                                                                                       
                                                                                                              
<a href="https://elitewiseescapes.com/successes" style={{ backgroundColor: '#23203e',                       
     color: '#ffffff', padding: '12px 20px', borderRadius: '5px', display: 'inline-block', textDecoration: 
       'none', fontWeight: 'bold' }}>Our Best Travel Stories</a>                                                 
                                                                                                           
                <p style={{ fontSize: '16px', lineHeight: '34px', marginTop: 50, marginBottom: '20px',    
       fontWeight: 'bold' }}>Want to Put Me on Your Calendar?</p>                                                                 
                 <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px'      
       }}>Some clients prefer to hop on a virtual call, learn more, discuss perks, and do their intake form in real time. If you’re ready to move forward quickly, just schedule a brief consultation call and we can go at your pace:</p>                                                                                     
                 <p style={{ fontSize: '16px', lineHeight: '24px', marginTop: 0, marginBottom: '20px',     
       fontWeight: 'bold' }}>Book a Quick Travel Chat:</p>
                </td>
              </tr>
              <tr>
                <td style={{ paddingBottom: '20px', textAlign: 'center' }}>
